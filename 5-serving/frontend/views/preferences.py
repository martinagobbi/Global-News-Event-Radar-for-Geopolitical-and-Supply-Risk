...
save_top = st.button("Save profile", type="primary", key="save_profile_top")
...
st.caption("Please add one item at a time. To ignore a question, you may leave it empty.")
...
if already_registered:
    st.write("**PLEASE REMEMBER TO CLICK \"SAVE PROFILE\" TO SAVE ANY EDITS YOU MAKE ON THIS PAGE.**")
save_bottom = st.button("Save profile", type="primary", key="save_profile_bottom")
